...
// })
//
// let aboutSlider = new Swiper('.slider-about-page__body', {
//     speed: 800,
//     slidesPerView: 1,
//     loop: true,
//     spaceBetween: 30,
...
//     const shortLine = document.querySelector('.header__line_short')
//     const longLine = document.querySelector('.header__line_long')
//     const paddingWidth = 60
//     const logoWidth = document.querySelector('.header .logo__image').offsetWidth
//
//     const containerWidth = document.querySelector('.header__container').offsetWidth
//     const offset = window.innerWidth - containerWidth
//
//     const shortLineWidth = offset - (offset / 2) - 11
//     const longLineWidth = window.innerWidth - (offset / 2) - logoWidth - paddingWidth
//
...
//
//
// const submenu = document.querySelectorAll('.menu__item_submenu')
//
// if (submenu.length > 0) {
